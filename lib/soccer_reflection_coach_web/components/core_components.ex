defmodule SoccerReflectionCoachWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SoccerReflectionCoachWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SoccerReflectionCoachWeb.Gettext, "errors", msg, opts)
    end
  end
